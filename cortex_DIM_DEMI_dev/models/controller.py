...
from cortex_DIM_DEMI_dev.configs.convnets import configs as convnet_configs
from cortex_DIM_DEMI_dev.configs.resnets import configs as resnet_configs
from cortex_DIM_DEMI_dev.models.dim import LocalDIM, GlobalDIM, LocalDEMI
from cortex_DIM_DEMI_dev.models.coordinates import CoordinatePredictor


logger = logging.getLogger('cortex_DIM_DEMI_dev')
...
class ControllerLocalDEMI(ModelPlugin):
    '''Model for managing semi-supervised losses and probes into encoder.
    ...
    def build(self, output_units=64, encoder_config='basic32x32', encoder_args={},
        ...
        if 'demi' in self.model_names:
            ...
            demi_discriminator = model.build(self.nets.encoder, copy.deepcopy(config))
