...
def infonce_loss(l, m):
    ...
    print('l_n size:{}'.format(l_n.size()))
    print('m_n size:{}'.format(m_n.size()))
    ...
    print('u_p size:{}'.format(u_p.size()))
    print('u_n size:{}'.format(u_n.size()))
    ...
    print('pred_lgt size:{}'.format(pred_lgt.size()))
    print('pred_log size:{}'.format(pred_log.size()))
